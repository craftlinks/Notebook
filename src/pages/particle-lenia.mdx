...
Explore the mesmerizing patterns and behaviors captured from various Particle Lenia experiments. Click on any image to view it in full size.
...
allow full screen? No, but maybe try maximise width (and height) of the canvas and make sure aspect ratio is taken into account.
